...
mtgcompare/
  ...
  pricing/        Market + MTGJSON price-history package
    service.py        orchestration + the /market computation
    history_store.py  PriceHistoryStore (DuckDB-file vs PostgreSQL backends)
